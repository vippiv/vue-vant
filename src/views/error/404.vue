  ...
  <div class="main-404">
    <div class="wscn-http404">
      ...
      <div class="message-404">
        ...
        <div class="message-404__info">请检查您输入的网址是否正确，请点击以下按钮返回主页</div>
        <span @click="backBtn" class="message-404__return-home">返回上一页</span>
      </div>
    </div>
  </div>
</template>
...
import img404cloud from '../../assets/images/404/404_cloud.png'
